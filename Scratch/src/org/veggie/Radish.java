package org.veggie;
// natural order is deteremined by size double
class Radish implements Comparable<Radish> {
    ...
    // Natural order is defined by 'size' (double) (because we chose size) defined by us
    @Override
    ...
    public String toString() {
            return String.format("%s: color=%s, size=%s, tailLength=%s, sprouts=%s,", getClass().getSimpleName(),
                    getColor(), getSize(), getTailLength(), getSprouts());
