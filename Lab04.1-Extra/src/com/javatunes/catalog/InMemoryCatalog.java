...
public class InMemoryCatalog implements Catalog {
     ...
     * right-lick -> Refactor -> Extract Method.
     ...
     */
    public MusicItem findCheapestByGenre() {
        return null;
    ...
    /* for (MusicItem item : catalogData) {
     ...
     if (item.getMusicCategory() == desiredCategory) {
       total += item.getPrice();
    ...
    */
    ...
    public Map<MusicCategory, Collection<MusicItem>> getAllGenreMap() {
        ...
        //  then put() (hint) that category and its collection in the result map.
