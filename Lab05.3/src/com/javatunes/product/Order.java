...
public class Order {
    ...
    /*
     * The Taxcalculator needed is a fucntion of location
     * well fetch it from a factory instead of 'new OnlineTax()', ets., in here
     */
    ...
    public void processCart(ShoppingCart<? extends Product> cart) {
        ...
        this.cost = cart.total(); // assign to field at top, its needed for getTax()
